...
Flug bleibt aber erhalten. Gazebo muss dafür nicht weiter angepasst werden.
...
src/p2_tabletennis/
|- worlds/tabletennis.sdf            # angepasst: Kameras 30 -> 60 Hz
`- p2_tabletennis/flight_ekf.py      # angepasst: R entfernungsabh., Q*dt, Fenster-Init
\end{lstlisting}
