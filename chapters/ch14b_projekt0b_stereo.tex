...
\code{/stereo/left/image}: bestätigt, dass die simulierte Kamera den Ball
liefert, bevor erkannt wird.}
...
\end{lstlisting}
\screenshotplaceholder{p0b-detection}{Kamerabild mit erkanntem Ball
(Mittelpunkt/Kreis). Belegt, dass die HSV-Schwellen den Ball isolieren.}
...
Ballposition (rot), Kalman-Schätzung (grün) und prädizierte Bahn (blau) -- der
Filter glättet das Messrauschen und schätzt voraus.}
